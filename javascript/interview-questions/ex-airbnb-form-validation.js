...
class Form extends React.Component {
  ...
  render() {
    ...
    return (
      <form>
        <label>
          <input value={input1.val} onChange={this._handleInputChange.bind(null, 'input1')} name="input1"/>
          <span>{getValidationMessage(this.state, 'input1')}</span>
        </label>

        <label>
          <input value={input2.val} onChange={this._handleInputChange.bind(null, 'input2')} name="input2"/>
          <span>{getValidationMessage(this.state, 'input2')}</span>
        </label>

        <label>
          <input value={input3.val} onChange={this._handleInputChange.bind(null, 'input3')} name="input3"/>
